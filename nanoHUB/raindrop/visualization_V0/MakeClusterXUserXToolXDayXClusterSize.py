...
clusterNameWriter = open(sys.argv[1].replace('.csv','_aubiceClusterNamesOnly.csv'), 'wb')

clusterWriter = csv.writer(open(sys.argv[1].replace('.csv','_aubiceClusters.csv'), 'wb'))
...
clusterWriter = open(sys.argv[1].replace('.csv','_aubiceClustersOnly.sql'), 'wb')
