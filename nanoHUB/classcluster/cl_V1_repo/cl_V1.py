...
from xu_cl_V1.xu_cl_V1 import core_classroom_analysis
from mi_cl_V1.mi_cl_V1 import core_cost_cluster_analysis
...
def main_online_users_TS_analysis():
    ...
    parser.add_argument('--geoip2_mmdb_filepath', help='full file path of mmdb file from GeoIP2', 
                                         action='store', default=os.path.join(os.path.dirname(os.path.realpath(__file__)), 'data', 'GeoLite2-City-new.mmdb'))
